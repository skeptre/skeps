...
export const PROJECTS: Project[] = [
  ...
  {
    slug: "sana-wajid-photography",
    title: "Sana Wajid Photography",
    description: "Production photography portfolio for a Manchester-based wedding photographer, built with Next.js to match a Pixieset brand identity with improved responsiveness, SEO, and contact reliability.",
    type: "client work / frontend / production",
    paragraphs: [
